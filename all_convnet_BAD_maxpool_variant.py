...
modelName = 'allconvnet_BAD_maxpool_variant.h5'
resultName = 'allconvnet_BAD_maxpool_variant.csv'
...
opt = Adam(decay = 1e-6)
x_train, x_test, y_train, y_test = train_test_split(feature, label, test_size=0.50, shuffle=True)
